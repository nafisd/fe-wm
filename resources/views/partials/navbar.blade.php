    ...
    <div class="navbar-wrapper">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item"><a class="navbar-brand" href="./ltr/vertical-compact-menu-template/index.html"><img class="brand-logo" alt="robust admin logo" src="app-assets/images/logo/logo-light-sm.png">
